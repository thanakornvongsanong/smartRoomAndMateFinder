        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading ">with your Facebook.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12 portfolio-item">
                    <a href="#" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/logo-facebook.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Login with Facebook</h4>
                        <a href="policy.php"><p class="text-muted">Privacy policy</p></a>
                    </div>
                </div>
