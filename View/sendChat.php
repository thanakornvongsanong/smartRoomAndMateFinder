<script  type="text/javascript" src="vender/jquery/jquery.min.js"></script>
    ...
    $sql = "INSERT INTO chat (user_id1, message,user_id2,chatdate) VALUES (" . $a . ",'" . $_POST["message"] . "'," . $_POST["user_id"] . ","."SYSDATE()". ")";
    ...
    for ($i = 0; $i < count($id); $i++) {
        ...
        echo "<img src=".$image." style='height:50px;width:50px'></img>   ". $message[$i]."                               "."<br>";
            ...
            echo "<p style='margin-left:80%'>".$message[$i]." <img src=".$image." style='height:50px;width:50px;'></img> </p>";
        }
    }
    ?>
