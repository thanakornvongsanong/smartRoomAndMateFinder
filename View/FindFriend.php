        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Find your roommmate.</h2>
                            ...
                            <br><br>
                                ...
                                <div class="form-group">  
                                    ...
                                    <div  class="col-lg-12">
                                         ...
                                         <div  class="col-lg-12" > 
                                            <div  class="col-lg-offset-4 col-lg-2"> <input type="radio" name="gotroom" value="Have" >Have </div>
                                            <div  class="col-lg-3"> <input type="radio" name="gotroom" value="Do not have"> Do not have </div>
                                        </div>
                                        <div  class="col-lg-12 text-right ">
                                             <p align="center"> Limitation (Choose if you agree)
                                                <input type="checkbox" name="limitation" value="Smoke"> Smoke
                                                <input type="checkbox" name="limitation" value="Pet"> Pet
                                                <input type="checkbox" name="limitation" value="Chrilden"> Chrilden
                                                <input type="checkbox" name="limitation" value="Snoring"> Snoring
                                           </p>
                ...
                <div class="row" style="padding-left: 0.5cm; padding-right: 0.5cm; padding-top: 1.0cm">
                  <div class="col-sm-4" portfolio-item>
                    <a href="#mate1" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f1.jpg" class="img-responsive img-circle" alt="">
                     </a>
                     <h4>Kay Garland</h4>
                ...
                <div class="col-sm-4" portfolio-item>
                    <a href="#mate2" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f2.jpg" class="img-responsive img-circle" alt="">
                     </a>
                     <h4>Larry Parker</h4>
                ...
                <div class="col-sm-4" portfolio-item>
                    <a href="#mate3" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f3.jpg" class="img-responsive img-circle" alt="">
                     </a>
              ...
              <div class="row" style="padding-left: 0.5cm; padding-right: 0.5cm; padding-top: 1.0cm">
                  <div class="col-sm-4" portfolio-item>
                    <a href="#mate4" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f6.jpg" class="img-responsive img-circle" alt="">
                     </a>
                     <h4>Kay Garland</h4>
                     <p class="text-muted">Lead Designer</p>
                     <ul class="list-inline social-buttons">
                ...
                <div class="col-sm-4" portfolio-item>
                    <a href="#mate5" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f6.jpg" class="img-responsive img-circle" alt="">
                     </a>
                     <h4>Larry Parker</h4>
                ...
                <div class="col-sm-4" portfolio-item>
                    <a href="#mate6" class="portfolio-link" data-toggle="modal">
                      <div class="team-member portfolio-hover">
                       <img src="images/f6.jpg" class="img-responsive img-circle" alt="">
                     </a>
                     <h4>Diana Pertersen</h4>
